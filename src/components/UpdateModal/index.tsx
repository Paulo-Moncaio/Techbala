          ...
          <div className="contentTwo">
            ...
            <input
              ...
              onChange={(e) =>
                setNovoUsuario({
                  ...novoUsuario,
                  endereco: { ...novoUsuario.endereco, rua: e.target.value },
                })
              }
              onKeyDown={(e) => {
                if (
            ...
            <select
              ...
              onChange={(e) =>
                setNovoUsuario({
                  ...novoUsuario,
                  endereco: { ...novoUsuario.endereco, estado: e.target.value },
                })
              }
            >
            ...
            <input
              ...
              onChange={(e) =>
                setNovoUsuario({
                  ...novoUsuario,
                  endereco: { ...novoUsuario.endereco, cep: e.target.value },
                })
              }
              onKeyDown={(e) => {
                if (
            ...
            <input
              ...
              onChange={(e) =>
                setNovoUsuario({
                  ...novoUsuario,
                  endereco: { ...novoUsuario.endereco, cidade: e.target.value },
                })
              }
              onKeyDown={(e) => {
                if (
            ...
            <input
              ...
              onChange={(e) =>
                setNovoUsuario({
                  ...novoUsuario,
                  telefone: { ...novoUsuario.telefone, fixo: e.target.value },
                })
              }
              ref={fixo}
              onKeyDown={(e) => {
