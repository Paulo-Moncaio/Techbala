...
exports.authRoute.put("/edituser", checkAuthMiddleware, function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, nome, rua, casanum, complemento, bairro, cep, cidade, estado, fixo, celular, carrinho, filter, teste, e_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = request.body, nome = _a.nome, rua = _a.rua, casanum = _a.casanum, complemento = _a.complemento, bairro = _a.bairro, cep = _a.cep, cidade = _a.cidade, estado = _a.estado, fixo = _a.fixo, celular = _a.celular, carrinho = _a.carrinho;
